...
public class UserRepository implements Repository{
    ...
    //chk pw using username for login
    public boolean chkLogin(String username, String password) throws SQLException {
        ...
        BCrypt.Result result = BCrypt.verifyer().verify(password.toCharArray(), pw_hash);   //chk whether passwords match
    ...
    public UUID chkToken(String token) throws SQLException {
        ...
        return (UUID) rs.getObject("user_id");  //return userId if token found
    }
    ...
    //chk password using userId (gotten from token validation)
